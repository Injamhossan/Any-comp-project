    ...
    <div className="space-y-6">
      ...
      {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {companies.map((comp) => (
                  <div key={comp.id} className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 hover:shadow-md transition-shadow">
                      ...
                      <h3 className="font-bold text-gray-900 text-lg truncate" title={comp.companyName}>{comp.companyName}</h3>
